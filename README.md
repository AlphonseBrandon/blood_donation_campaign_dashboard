...
│                         blood_donation_campaign_dashboard and configuration for tools like black
│
...
│
└── blood_donation_campaign_dashboard   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes blood_donation_campaign_dashboard a Python module
    │
